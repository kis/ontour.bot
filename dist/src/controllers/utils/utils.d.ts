...
declare function getEventsListTemplate(
  eventsList: any,
  value: Event,
  type: any
): any;
...
declare function getArtistImage(artist: { displayName: string }): Promise<any>;
declare function getEventsByArtist(
  artist: any,
  fromDate: any,
  toDate: any,
  page: number
...
declare function getEventsByMetroAreaID(
  metroAreaID: number,
  fromDate: any,
  toDate: any,
  page: number
