...
async function fetchLocationsByCoords(location: { latitude: any, longitude: any }) {
    return request
        .get(`${constantsApi.SONGSICK_API_DOMAIN}/search/locations.json`)
        .query({ 
            apikey: SONGKICK_API_KEY,
...
async function fetchEventsByMetroAreaID(id: number, fromDate: any, toDate: any, page: number) {
    return request
...
async function fetchEventsByArtist(artist: any, fromDate: any, toDate: any, page: number) {
    return request
