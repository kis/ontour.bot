...
async function askLanguage(chatId) {
    bot_1.default.sendMessage(chatId, instance_1.getLanguage().SET_LANG, constantsReply.KEYBOARD_LANGUAGE_OPTIONS);
    return await new Promise((resolve, reject) => {
        bot_1.default.once("message", async (reply) => {
            ...
            bot_1.default.sendMessage(chatId, instance_1.getLanguage().LANG_IS(reply.text), constantsReply.REPLY_OPTIONS);
            resolve(true);
        });
    });
}
